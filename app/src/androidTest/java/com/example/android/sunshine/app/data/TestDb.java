...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: No record returend from the weather insert query",cursor.moveToFirst());
    ...
    public long insertLocation() {
        ...
        // Move the cursor to a valid database row and check if a record is back
        assertTrue("Error: No record returend from the location insert query",cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Location query data verification failed",cursor,contentValues);

        //Move the cursor to ensure there is only once record returned
        assertFalse("Error: more than one record returned by the location query",cursor.moveToNext());
        // Finally, close the cursor and database
        cursor.close();
        sqLiteDatabase.close();
