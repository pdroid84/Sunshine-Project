...
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fakeData.add("Monday-Sunny-88/63");
        fakeData.add("Tuesday-Sunny-88/63");
        ...
        fakeData.add("Sunday-Sunny-88/63");


        dataAdapter = new ArrayAdapter<String>(getActivity(),R.layout.list_item_forecast,
    ...
    public class FetchWeatherTask extends AsyncTask<String,Void, String[]> {
        ...
        private String data_format_value = "json";
        private String units_value = "metric";
        private int cnt_value = 14;
        String[] returnResult;
        @Override
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                final String DATA_FORMAT_PARAM = "mode";
                final String UNITS_PARAM = "units";
                final String CNT_PARAM = "cnt";
                final String API_PARAM = "APPID";
                Uri uriBase = Uri.parse(FORECAST_BASE_URL);
                Uri.Builder builder = uriBase.buildUpon();
                Uri uriFinal = builder.appendQueryParameter(QUERY_PARAM, params[0])
                        .appendQueryParameter(DATA_FORMAT_PARAM,data_format_value)
                        .appendQueryParameter(UNITS_PARAM, units_value)
                        .appendQueryParameter(CNT_PARAM, Integer.toString(cnt_value))
                        .appendQueryParameter(API_PARAM,BuildConfig.OPEN_WEATHER_API_KEY)
                        .build();

                URL url = new URL(uriFinal.toString());
                Log.v(LOG_TAG,"URL->"+uriFinal.toString());
            ...
            try {
                returnResult = getWeatherDataFromJson(forecastJsonStr,cnt_value);
