...
public class SettingsActivity extends PreferenceActivity
    ...
    private void setPreferenceSummary(Preference preference, Object value) {
        ...
        Log.v(LOG_TAG, "Preference stringValue = " + stringValue);
        Log.v(LOG_TAG, "Preference key = " + key);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if ( key.equals(getString(R.string.pref_location_key)) ) {
            ...
            // Wipe out any potential PlacePicker lat & log values so that we can use this text entry.
            SharedPreferences.Editor editor = sharedPreferences.edit();
            ...
            // Icon packs have changed. update lists of weather entries accordingly
            getContentResolver().notifyChange(WeatherContract.WeatherEntry.CONTENT_URI, null);
        }
    }

    //System will call this when up button is pressed to get parent activity intent
